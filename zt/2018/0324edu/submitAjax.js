function updateInfoString() {
  ...
  var oName = $("#uname").val() || $("#uname2").val();
  var oMobile = $("#umobile").val() || $("#umobile2").val();
  var oPhone = $("#uphone").val();
  var oQQ = $("#qq").val();
  var oEmail = $("#email").val();
  var oCity = $("#city").val();
  var oCr_xueli = ($("#cr_xueli").val()) || ($("#cr_xueli").html());
  var oWt_xueli = ($("#wt_xueli").val()) || ($("#wt_xueli").html()) || $("#wt_xueli2").val();
  var oCr_yusuan = ($("#cr_yusuan").val()) || ($("#cr_yusuan").html()) || $("#cr_yusuan2").val();
  ...
  var oWt_more = $("#wt_more").val() || $("#wt_more2").val() || $("#wt_more3").val() || $("#wt_more4").val() || $("#wt_more5").val();
  var oWechat = $("#wechat").val();
  var oYx_guojia = ($("#yx_guojia").html() || $("#yx_guojia").val()) || $("#yx_guojia2").val();
  var oTitle = $("title").attr("data-title");
  ...
  if (oYx_guojia == "未选择") {
    ...
    oYx_guojia = $("#yx_guojia").val() || $("#yx_guojia").html() || $("#yx_guojia2").val();
  } else {
    oYx_guojia = "";
  }
  if (oWechat) {
  ...
  if (oMobile) {
    oMobile = $("#umobile").val() || $("#umobile2").val();
  } else {
    oMobile = "";
  }
  if (oEmail) {
  ...
  if (oWt_xueli == "未选择") {
    ...
    oWt_xueli = $("#wt_xueli").val() || $("#wt_xueli").html() || $("#wt_xueli2").val();
  } else {
    oWt_xueli = "";
  }
  if (oCr_yusuan == "未选择") {
    ...
    oCr_yusuan = $("#cr_yusuan").val() || $("#cr_yusuan2").val() || $("#cr_yusuan").html();
  } else {
    oCr_yusuan = "";
  }
  if (oWt_shijian == "未选择") {
